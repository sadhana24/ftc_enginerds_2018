 ...
 */
@com.qualcomm.robotcore.eventloop.opmode.Autonomous(name = "BLUE Right - Complex", group = "BLUE Alliance")
//@Disabled
public class AutoBlueRightAlternate extends AutonomousMec {
    @Override
