 ...
 */
@com.qualcomm.robotcore.eventloop.opmode.Autonomous(name = "BLUE Left - Simple", group = "BLUE Alliance")
//@Disabled
public class AutoBlueLeft extends AutonomousMec {
    @Override
    public void runOpMode() throws InterruptedException {
        super.g_AllianceColor = EngiNerdsConstants.ALLIANCE_COLOR_BLUE;
        super.g_DriverPosition = EngiNerdsConstants.DRIVER_POSITION_LEFT_SIMPLE;
        super.runOpMode();
    }
}
